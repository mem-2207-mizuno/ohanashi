...
import { StartRecordingUseCase } from '../../../application/voice/StartRecordingUseCase';
import { AudioRecorderGateway } from '../../../infrastructure/voice/AudioRecorderGateway';
...
describe('StartRecordingUseCase', () => {
  it('録音を開始できる（AudioRecorderのstartを呼ぶ）', () => {
    ...
    const useCase = new StartRecordingUseCase(recorder, gateway);
